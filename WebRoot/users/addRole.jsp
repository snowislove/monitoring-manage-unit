		...
		<div style="padding:10px 0 10px 60px">
		    <form id="ff" action="saveRole.action" method="post">
		    	...
		    	<tr>
	    			...
	    			<td><input class="easyui-validatebox" type="text" style="width:150px" missingMessage="请输入角色名称" name="role.roleName" data-options="required:true"></input></td>
	    		</tr>
	    		<tr>
	    			<td><label>角色描述：</label></td>
	    			<td><textarea class="datagrid-editable-input"  name="role.roleDesc" style="resize:none;width:150px;height:50px"></textarea> 
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>
