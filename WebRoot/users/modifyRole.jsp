		...
		<div style="padding:10px 0 10px 60px">
		    ...
		    <input type="hidden" name="role.id" value="${ mrole.id}"/>
		    	...
		    	<tr>
	    			...
	    			<td><input class="easyui-validatebox" type="text" style="width:150px" missingMessage="请输入部门名称" name="role.roleName" data-options="required:true" value="${mrole.roleName }"></input></td>
	    		</tr>
	    		<tr>
	    			<td><label>角色描述：</label></td>
	    			<td><textarea class="datagrid-editable-input"  name="role.roleDesc" style="resize:none;width:150px;height:50px">${mrole.roleDesc }</textarea> 
	    			</td>
	    		</tr>
	    		</table>
		    </form>		     
